...
if uploaded_file is not None:
    ...
    if st.sidebar.button("Show Analysis"):
        ...
        # Stats Area
        num_messages, words, media_messages, num_links = support.fetch_stats(selected_user,df)
        ...
        user_heatmap = support.activity_heatmap(selected_user,df)
        fig,ax = plt.subplots()
        ...
        with col2:
            if not emoji_df.empty:
              fig,ax = plt.subplots()
              #st.write("Emoji DF columns:", emoji_df.columns)
